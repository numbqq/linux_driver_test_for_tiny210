...
int main(int argc, char** argv)
{
    ...
    if ((argc == 2) || (argc > 2 && !strcmp(argv[2], "set")))
    {
    	...
    	usleep(50000);
    	//mire();
	//	lcd_draw_cross(50, 50, 50, 0x0000ff);
//		lcd_draw_cross(50, 50, 50, 0x0000ff);
//		lcd_draw_cross(240, 400, 50, 0x00ff00);
//		lcd_draw_cross(430, 750, 50, 0xff0000);
//		lcd_draw_hline(240, 0, 800, 0xff0000);
//		lcd_draw_vline(400, 0, 480, 0x00ff00);
